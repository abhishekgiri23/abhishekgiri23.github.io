...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","Draft(.{1,100})","value",["macro",56]],["map","key","Testing","value",["macro",56]],["map","key","Staging","value",["macro",58]],["map","key","Live","value",["macro",57]]]
    },{
      "function":"__smm",
      "vtp_setDefaultValue":true,
      "vtp_input":["macro",5],
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Efunction getParameterByName(a){a=a.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");a=new RegExp(\"[\\\\?\\x26]\"+a+\"\\x3d([^\\x26#]*)\");a=a.exec(location.search);return null===a?\"\":decodeURIComponent(a[1].replace(\/\\+\/g,\" \"))}function getCookieGtm(a){a+=\"\\x3d\";for(var d=document.cookie.split(\";\"),c=0;c\u003Cd.length;c++){for(var b=d[c];\" \"==b.charAt(0);)b=b.substring(1);if(0==b.indexOf(a))return b.substring(a.length,b.length)}return\"\"}\nfunction setCookieGtm(a,d){document.cookie=a+\"\\x3d\"+d+\";path\\x3d\/;domain\\x3d.zety.com\"}function getCookieItem(a){var d=getCookieGtm(\"gtmvalues\"),c=[],b=\"\";null!=d\u0026\u0026void 0!=d\u0026\u0026\"\"!=d\u0026\u0026(c=JSON.parse(d),$.each(c,function(e,f){f.n===a\u0026\u0026(b=f.v)}));return b}function addCookieItem(a,d){var c=getCookieGtm(\"gtmvalues\"),b=[];null!=c\u0026\u0026void 0!=c\u0026\u0026\"\"!=c\u0026\u0026(b=JSON.parse(c));c={n:a,v:d};\"\"==getCookieItem(a)?b.push(c):$.map(b,function(e,f){e.n==a\u0026\u0026(e.v=d)});setCookieGtm(\"gtmvalues\",JSON.stringify(b))}\n$(window).on(\"load\",function(){var a,d=\"USD\";if(a=document.getElementById(\"hdnPurchaseConfirmationViewModel\"))a=a.value,a=JSON.parse(a),a=a.BillingAmmount,\/\\u20b9\/.test(a.textContent)\u0026\u0026(a=a.replace(\"\\u20b9\",\"\"),d=\"Rupees\"),\/$\/.test(a.textContent)\u0026\u0026(a=a.replace(\"$\",\"\"));var c=getParameterByName(\"customerid\"),b=getParameterByName(\"orderid\"),e=c+b,f=getCookieItem(\"fbszty\");(\"\"==f||f!=e)\u0026\u00260\u003Cc\u0026\u00260\u003Cb\u0026\u0026(fbq(\"track\",\"Purchase\",{value:a,currency:d}),addCookieItem(\"fbszty\",e))});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":327
      ...
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Efunction getParameterByName(a){a=a.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");a=new RegExp(\"[\\\\?\\x26]\"+a+\"\\x3d([^\\x26#]*)\");a=a.exec(location.search);return null===a?\"\":decodeURIComponent(a[1].replace(\/\\+\/g,\" \"))}function getCookieGtm(a){a+=\"\\x3d\";for(var d=document.cookie.split(\";\"),c=0;c\u003Cd.length;c++){for(var b=d[c];\" \"==b.charAt(0);)b=b.substring(1);if(0==b.indexOf(a))return b.substring(a.length,b.length)}return\"\"}\nfunction setCookieGtm(a,d){document.cookie=a+\"\\x3d\"+d+\";path\\x3d\/;domain\\x3d.zety.com\"}function getCookieItem(a){var d=getCookieGtm(\"gtmvalues\"),c=[],b=\"\";null!=d\u0026\u0026void 0!=d\u0026\u0026\"\"!=d\u0026\u0026(c=JSON.parse(d),$.each(c,function(e,f){f.n===a\u0026\u0026(b=f.v)}));return b}function addCookieItem(a,d){var c=getCookieGtm(\"gtmvalues\"),b=[];null!=c\u0026\u0026void 0!=c\u0026\u0026\"\"!=c\u0026\u0026(b=JSON.parse(c));c={n:a,v:d};\"\"==getCookieItem(a)?b.push(c):$.map(b,function(e,f){e.n==a\u0026\u0026(e.v=d)});setCookieGtm(\"gtmvalues\",JSON.stringify(b))}\n$(document).ready(function(){var a=\"\",d=\"USD\",c=",["escape",["macro",43],8,16],",b=getParameterByName(\"mode\");b=b.toLowerCase();if(\"update\"!=b\u0026\u0026\"alreadysubscribeduser\"!=b){c\u0026\u0026(a=c.replace(\"$\",\"\"));c=getParameterByName(\"customerid\");b=getParameterByName(\"orderid\");var e=c+b,f=getCookieItem(\"fbszty\");(\"\"==f||f!=e)\u0026\u00260\u003Cc\u0026\u00260\u003Cb\u0026\u0026(fbq(\"track\",\"Purchase\",{value:a,currency:d}),addCookieItem(\"fbszty\",e))}});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":330
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,c,e,f,d,b){a.hj=a.hj||function(){(a.hj.q=a.hj.q||[]).push(arguments)};a._hjSettings={hjid:215629,hjsv:6};d=c.getElementsByTagName(\"head\")[0];b=c.createElement(\"script\");b.async=1;b.src=e+a._hjSettings.hjid+f+a._hjSettings.hjsv;d.appendChild(b)})(window,document,\"https:\/\/static.hotjar.com\/c\/hotjar-\",\".js?sv\\x3d\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":4
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.hj=window.hj||function(){(hj.q=hj.q||[]).push(arguments)};hj(\"tagRecording\",[\"",["escape",["macro",41],7],"\",\"",["escape",["macro",42],7],"\",\"",["escape",["macro",41],7],":",["escape",["macro",42],7],"\"]);var experimentName=",["escape",["macro",41],8,16],",experimentVariant=",["escape",["macro",42],8,16],",experimentVariantWithoutWhitespaces=experimentVariant.replace(\/\\s\/g,\"\"),experimentNameWithoutWhitespaces=experimentName.replace(\/\\s\/g,\"\");hj(\"trigger\",experimentVariantWithoutWhitespaces);hj(\"trigger\",experimentNameWithoutWhitespaces);\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":321
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Efunction getParameterByName(b){b=b.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");b=new RegExp(\"[\\\\?\\x26]\"+b+\"\\x3d([^\\x26#]*)\");b=b.exec(location.search);return null===b?\"\":decodeURIComponent(b[1].replace(\/\\+\/g,\" \"))}var utm_source=getParameterByName(\"utm_source\");utm_source=utm_source.toLowerCase();var utm_medium=getParameterByName(\"utm_medium\");utm_medium=utm_medium.toLowerCase();var utm_campaign=getParameterByName(\"utm_campaign\");utm_campaign=utm_campaign.toLowerCase();\nvar pathname=window.location.pathname,a=window.location.search;\"\"==document.referrer\u0026\u0026\"1\"==pathname.length\u0026\u0026\"\"==a\u0026\u0026fbq(\"trackCustom\",\"Direct Visit - Home Page\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":325
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Efunction getParameterByName(a){a=a.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");a=new RegExp(\"[\\\\?\\x26]\"+a+\"\\x3d([^\\x26#]*)\");a=a.exec(location.search);return null===a?\"\":decodeURIComponent(a[1].replace(\/\\+\/g,\" \"))}var utm_source=getParameterByName(\"utm_source\");utm_source=utm_source.toLowerCase();var utm_medium=getParameterByName(\"utm_medium\");utm_medium=utm_medium.toLowerCase();var utm_campaign=getParameterByName(\"utm_campaign\");utm_campaign=utm_campaign.toLowerCase();\n\"\"!=utm_source\u0026\u0026\"\"!=utm_medium\u0026\u0026(\"google\"!=utm_source\u0026\u0026\"bing\"!=utm_source||\"sem\"!=utm_medium||(-1\u003Cutm_campaign.indexOf(\"brand\")||\"1446637678\"==utm_campaign||\"1679764980\"==utm_campaign||\"957323010\"==utm_campaign||\"1408397970\"==utm_campaign||\"1649425665\"==utm_campaign||\"957323007\"==utm_campaign||\"1017839414\"==utm_campaign||\"1408397967\"==utm_campaign||\"1680560810\"==utm_campaign?fbq(\"trackCustom\",\"Paid Search Visit - Brand\",{utm_source:utm_source,utm_medium:utm_medium,utm_campaign:utm_campaign}):fbq(\"trackCustom\",\n\"Paid Search Visit - Non-Brand\",{utm_source:utm_source,utm_medium:utm_medium,utm_campaign:utm_campaign})));\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":326
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,e,b,f,g,c,d){a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};c=e.createElement(f);c.async=1;c.src=\"https:\/\/www.clarity.ms\/tag\/\"+g;d=e.getElementsByTagName(f)[0];d.parentNode.insertBefore(c,d)})(window,document,\"clarity\",\"script\",\"6ddhr9w5kh\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":331
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,e,b,f,g,c,d){a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};c=e.createElement(f);c.async=1;c.src=\"https:\/\/www.clarity.ms\/tag\/\"+g;d=e.getElementsByTagName(f)[0];d.parentNode.insertBefore(c,d)})(window,document,\"clarity\",\"script\",\"6ddl34np12\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":333
  ...
  "rules":[
    ...
    [["if",1,5],["add",4,7,118]],
    [["if",9,10,11],["add",5]],
    [["if",11,12],["unless",13],["add",6]],
    [["if",1,14,15],["add",7,59,1]],
    [["if",15,16,17],["add",7,59]],
    [["if",20],["unless",18,19],["add",8]],
    [["if",21,22],["add",9]],
    [["if",1],["add",10,15,45,56,0,122,123,65,66,67,68,69,70,71,72,73,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116]],
    [["if",30],["unless",9,24,25,26,27,28,29],["add",11]],
    [["if",31,32,40],["unless",33,34,35,36,37,38,39],["add",12]],
    [["if",11,41,42,43,44],["add",13]],
    [["if",45],["add",14,31]],
    [["if",40,46],["add",15]],
    [["if",47],["add",16,35]],
    [["if",11,48,49,50],["add",17]],
    [["if",40,51,52],["add",18]],
    [["if",1,53],["add",18,43]],
    [["if",54,55,56,57],["add",19]],
    [["if",11,58,59],["add",20]],
    [["if",11,59,60],["add",20]],
    [["if",11,61,62],["unless",63],["add",21]],
    [["if",1,64],["unless",65],["add",22,43]],
    [["if",9,56,66,67,68],["add",23]],
    [["if",56,69,70,71,72],["add",23]],
    [["if",11,73,74,75],["add",24]],
    [["if",1,9],["add",25,43]],
    [["if",1,55],["add",26,43]],
    [["if",11,31,76],["unless",77],["add",27]],
    [["if",11,31,78,79],["add",28]],
    [["if",11,31,76,77],["add",28]],
    [["if",40,51,80],["add",29]],
    [["if",81],["add",30]],
    [["if",11,82,83],["add",32]],
    [["if",9,11,84],["add",33]],
    [["if",1,23],["add",34],["block",9,10,14,31,45,0]],
    [["if",85],["add",36]],
    [["if",86],["add",37]],
    [["if",87],["add",38]],
    [["if",88],["add",39,40]],
    ...
    [["if",103,104],["add",52]],
    [["if",103,105],["add",52]],
    [["if",56,106,107,108],["add",53]],
    [["if",11,109],["add",54]],
    [["if",103,110],["add",55]],
    [["if",11,111,112],["add",57]],
    [["if",11,112,113],["add",57]],
    [["if",11,112,114],["add",57]],
    [["if",11,115],["add",58]],
    [["if",49,103,116],["add",60]],
    [["if",49,103,117],["add",61]],
    [["if",11,118],["add",62]],
    [["if",11,119],["add",63]],
    [["if",1,120],["add",64]],
    [["if",1,31],["add",74]],
    [["if",1,121],["add",117]],
    [["if",40,122,123],["add",117]],
    [["if",1,122,123],["add",117]],
    [["if",1,124],["add",117]],
    [["if",20,125],["add",119]],
    [["if",126],["add",120]],
    [["if",1,127],["add",121,122]],
    [["if",128,129],["add",2]],
    [["if",1,130],["add",124]],
    [["if",1,4],["block",3,0]],
    [["if",6,7],["block",4,7,117,0,118]],
    [["if",7,8],["block",4,7,0,118]],
    [["if",33,34,35,36,37,38,39,40],["block",12,18]]]
},
"runtime":[]
...
var Pd=[C.B,C.I],Qd=function(a){var b=a[C.Qd];b&&E(40);var c=a[C.Rd];c&&E(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Pd,f)){var h=f,k=a[f],l=d[e];Ad().set(h,k,l,"IN","IN-DL",c)}else{}},Rd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
